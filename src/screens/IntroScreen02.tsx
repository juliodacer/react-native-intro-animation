...
import { INTRO_SCREEN_02 } from '../utils/constanst';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <Animated.View entering={FadeInDown.delay(400).duration(1000).springify()}>
          <ScreenIndicator count={6} activeIndex={1} />
        </Animated.View>
        <Animated.View entering={FadeInDown.delay(600).duration(1000).springify()} style={{ alignItems: 'center' }}>
          <PrimaryButton label='Siguiente' onPress={() => navigation.replace('IntroScreen03')} />
        </Animated.View>
      </View>
    </View>
  )
